...
const producto3 = new Producto("Niños | Zimith", "ZH215111", "Remera Zimith Sicba Basica", "Azul", "L", 4, 3199,"Estampa a un color en frente. Tinta con base soft.", "./img/producto13.jpg", "./img/producto13b.jpg", "./img/producto13c.jpg")
...
const producto5 = new Producto("Musculosas | Zimith", "ZH215107", "Musculosa Zimith Perlo", "Blanco", "M", 4, 2799,"Estampa a un color en frente. Tinta con base soft.", "./img/producto5.jpg", "./img/producto5b.jpg", "./img/producto5c.jpg")
const producto6 = new Producto("Niños | Zimith", "ZH215112", "Short De Baño Zimith Demaf Niño", "Rojo", "L", 4, 2599,"Short de baño 14'' elastizado.", "./img/producto14.jpg", "./img/producto14b.jpg", "./img/producto14c.jpg")
const producto7 = new Producto("Musculosas | Zimith", "ZH215108", "Musculosa Zimith Torno", "Verde", "XL", 4, 3699,"Estampa a un color en frente. Tinta con base soft.", "./img/producto6.jpg", "./img/producto6b.jpg", "./img/producto6c.jpg")
...
const producto13 = new Producto("Musculosas | Zimith", "ZH215109", "Musculosa ZImith Krape", "Negro", "S", 4, 2799,"Estampa a un color en frente. Tinta con base soft.", "./img/producto15.jpg", "./img/producto15b.jpg", "./img/producto15c.jpg")
const producto14 = new Producto("Accesorios | Zimith", "ZH215113", "Billetera Zimith Furgo Hombre", "Negro", "U", 4, 2199,"Billetera de eco cuero, 5 compartimientos para tarjetas.", "./img/producto9.jpg", "./img/producto9b.jpg", "./img/producto9c.jpg")
